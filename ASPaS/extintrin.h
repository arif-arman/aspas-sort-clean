...
namespace util
{
    ...
    __m256 _my_mm256_cmpgt_ps(__m256 v0, __m256 v1)
    {
        ...
        __m128i sl1, sh1, sl2, sh2;
        __m128 rl, rh;
        sl1 = _mm256_extractf128_si256(_mm256_castps_si256(v0), 0);
        sh1 = _mm256_extractf128_si256(_mm256_castps_si256(v0), 1);
        sl2 = _mm256_extractf128_si256(_mm256_castps_si256(v1), 0);
        sh2 = _mm256_extractf128_si256(_mm256_castps_si256(v1), 1);
        rl = _mm_cmpgt_ps(_mm_castsi128_ps(sl1), _mm_castsi128_ps(sl2));
        rh = _mm_cmpgt_ps(_mm_castsi128_ps(sh1), _mm_castsi128_ps(sh2));
        h1 = _mm256_castsi256_ps(_mm256_insertf128_si256(_mm256_castps_si256(v1), _mm_castps_si128(rl), 0));
        h1 = _mm256_castsi256_ps(_mm256_insertf128_si256(_mm256_castps_si256(h1), _mm_castps_si128(rh), 1));
        return h1;
    }
#endif
